...
class EC_DE:
    ...
    def register_taxi(self):
        try:
            url = "https://127.0.0.1:5001/register_taxi"
            response = requests.post(url, json={"id": self.id_taxi}, verify="ca.crt")
    ...
    def authenticate_taxi(self):
        try:
            ...
            list_url = "https://127.0.0.1:5001/list_taxis"
            response = requests.get(list_url, verify="ca.crt")
            ...
            if self.id_taxi not in taxis_registrados:
                ...
                return
            url = "https://127.0.0.1:5001/authenticate_taxi"
            response = requests.post(url, json={"id": self.id_taxi}, verify="ca.crt")
            if response.status_code == 200:
    ...
    def unregister_taxi(self):
        try:
            ...
            if response.status_code == 200:
                ...
                delete_url = "https://127.0.0.1:5001/delete_taxi"
                delete_response = requests.delete(delete_url, json={"id": self.id_taxi}, verify="ca.crt")
